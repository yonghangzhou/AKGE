...
def add_item_side_information(Graph, side_info_file_name):
    with open(side_info_file_name,'r') as fr_auxiliary:
        for line in fr_auxiliary:
            ...
            Graph.add_edge(movie_node, genre_node,attr='moviegenre')
            ...
            for director_id in director_list:
                ...
                Graph.add_edge(movie_node, director_node,attr='moviedirector')
            ...
            for actor_id in actor_list:
                ...
                Graph.add_edge(movie_node, actor_node,attr='movieactor')
